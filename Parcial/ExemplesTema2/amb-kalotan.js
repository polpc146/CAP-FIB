/****
     ...
     java -cp <path on s'ha instal·lat Rhino>/rhino1.7.14/lib/rhino-1.7.14.jar org.mozilla.javascript.tools.shell.Main -opt -2 amb-kalotan.js
****/
...
let progenitor1    = amb(['m','f']);
let progenitor2    = amb(['m','f']);
let kibi           = amb(['m','f']);
let kibi_va_dir    = amb(['m','f']);
let kibi_va_mentir = amb([true,false]);
